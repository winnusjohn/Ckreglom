    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <a class="col-lg-offset-5 btn btn-success" href="{{ route('testimonial.create') }}">Add New</a>
        ...
        <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="{{ route('testimonial.edit', $testimonial->id) }}"><span class="glyphicon glyphicon-edit">Edit</span></a></td>
                  <td>
