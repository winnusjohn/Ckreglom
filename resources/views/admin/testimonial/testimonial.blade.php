            ...
            {{ csrf_field() }}
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="title" name="title" placeholder="Testimonial title" >
                </div>

                <div class="form-group">
                  <label for="testimonial_name">Testimony name</label>
                  <input type="text" class="form-control" id="subtitle" name="name" placeholder="Testimonial name">
                </div>
                <br>
                <label>
